---
question: How much can a landlord raise the rent each year in California?
...
annotations:
  - date: '2026-06-25'
    type: additive
    note: >-
      The cap only binds if a single-family home or condo is not properly
      exempted: the owner must serve the written exemption notice to each
      successive tenant, or an otherwise-exempt property becomes subject to the
