...
topicDescription: "How California's statewide rules on rent increases and evictions affect Ventura County rental owners."
type: "objective"
derivedFrom:
...
annotations:
  - date: "2026-06-25"
    type: "additive"
    note: "The inflation figure in the cap is the regional CPI, which is published annually and varies by area — so the exact maximum increase differs by region and resets each year. Always check the current CPI for the property's metro area before issuing an increase notice."
---
